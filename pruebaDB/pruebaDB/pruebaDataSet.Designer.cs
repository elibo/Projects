...
namespace pruebaDB {
    ...
    public partial class pruebaDataSet : global::System.Data.DataSet {
        ...
        public partial class usuariosDataTable : global::System.Data.TypedTableBase<usuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usuariosRow AddusuariosRow(int id, string nombre, string username, string pass) {
...
namespace pruebaDB.pruebaDataSetTableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[usuarios] WHERE (([id] = @Original_id) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_pass = 1 AND [pass] IS NULL) OR ([pass] = @Original_pass)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[usuarios] ([id], [nombre], [username], [pass]) VALUES (@id, @n" +
                "ombre, @username, @pass);\r\nSELECT id, nombre, username, pass FROM usuarios WHERE" +
                " (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[usuarios] SET [id] = @id, [nombre] = @nombre, [username] = @username, [pass] = @pass WHERE (([id] = @Original_id) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_pass = 1 AND [pass] IS NULL) OR ([pass] = @Original_pass)));
SELECT id, nombre, username, pass FROM usuarios WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::pruebaDB.Properties.Settings.Default.pruebaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nombre, username, pass FROM dbo.usuarios";
        ...
        public virtual int Fill(pruebaDataSet.usuariosDataTable dataTable) {
        ...
        public virtual pruebaDataSet.usuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            pruebaDataSet.usuariosDataTable dataTable = new pruebaDataSet.usuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pruebaDataSet.usuariosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nombre, string Original_username, string Original_pass) {
        ...
        public virtual int Insert(int id, string nombre, string username, string pass) {
        ...
        public virtual int Update(int id, string nombre, string username, string pass, int Original_id, string Original_nombre, string Original_username, string Original_pass) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string username, string pass, int Original_id, string Original_nombre, string Original_username, string Original_pass) {
            return this.Update(Original_id, nombre, username, pass, Original_id, Original_nombre, Original_username, Original_pass);
        }
    }
