...
namespace WindowsFormsApplication2 {
    ...
    public partial class pruebaDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usersRow AddusersRow(int id, string nombre, string clave) {
        ...
        public partial class usersRow : global::System.Data.DataRow {
            ...
            public string clave {
                get {
                    try {
                        return ((string)(this[this.tableusers.claveColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'clave\' in table \'users\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableusers.claveColumn] = value;
                }
            }
            ...
            public bool IsclaveNull() {
                return this.IsNull(this.tableusers.claveColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetclaveNull() {
                this[this.tableusers.claveColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApplication2.pruebaDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[users] WHERE (([id] = @Original_id) AND ((@IsNull_nombre = 1 A" +
                "ND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_clave = 1 A" +
                "ND [clave] IS NULL) OR ([clave] = @Original_clave)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([id], [nombre], [clave]) VALUES (@id, @nombre, @clave)" +
                ";\r\nSELECT id, nombre, clave FROM users WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [id] = @id, [nombre] = @nombre, [clave] = @clave WHERE (([id] = @Original_id) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_clave = 1 AND [clave] IS NULL) OR ([clave] = @Original_clave)));
SELECT id, nombre, clave FROM users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication2.Properties.Settings.Default.pruebaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nombre, clave FROM dbo.users";
        ...
        public virtual int Fill(pruebaDataSet.usersDataTable dataTable) {
        ...
        public virtual pruebaDataSet.usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            pruebaDataSet.usersDataTable dataTable = new pruebaDataSet.usersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pruebaDataSet.usersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nombre, string Original_clave) {
        ...
        public virtual int Insert(int id, string nombre, string clave) {
        ...
        public virtual int Update(int id, string nombre, string clave, int Original_id, string Original_nombre, string Original_clave) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string clave, int Original_id, string Original_nombre, string Original_clave) {
            return this.Update(Original_id, nombre, clave, Original_id, Original_nombre, Original_clave);
        }
    }
